 ...
 */
package ru.kamatech.qaaf.database.com.ibatis.common.beans;
...
public class ClassInfo {
  ...
  /**
   * Gets an array of the readable ru.kamatech.qa.properties for an object
   *
   * @return The array
   */
  ...
  /**
   * Gets an array of the writeable ru.kamatech.qa.properties for an object
   *
   * @return The array
   */
